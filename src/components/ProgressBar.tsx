  ...
  return (
    <div className="relative block h-[20px] w-full rounded-full bg-custom-light-green">
      <div
        ...
        className={`${progressBarBackgroundColor} transition-width flex h-[20px] items-center justify-end rounded-full bg-custom-green pr-[10px] text-right text-xs leading-5 text-white duration-500`}
      >
        {returnPercentage()}
      </div>
    </div>
